    ...
    <b-container class="mt-4">
        ...
        <b-row class="">
            <b-col cols="12" col lg="4" sm="12" md="6" class="p-4" >
                <h5>Kecamatan Balige</h5>
                <b-img rounded="" src="https://upload.wikimedia.org/wikipedia/commons/2/2e/Kecamatan_Balige%2C_Toba_Samosir_02.jpg" fluid></b-img>
            </b-col>
            <b-col cols="12" col lg="4" sm="12" md="6" class="p-4" >
                <h5>Kecamatan Balige</h5>
                <b-img rounded="" src="https://upload.wikimedia.org/wikipedia/commons/2/2e/Kecamatan_Balige%2C_Toba_Samosir_02.jpg" fluid></b-img>
        ...
        <b-row class="p-4">
            <p>Deskripsi: Desa Meat berlokasi di kecamatan balige, desa ini sering digubakan sebagai tempat untuk berkemah
            oleh para masyarakat dari luar kota maupun dari dalam daerah. Hampir setiap minggu tempat ini ramai digunakan
